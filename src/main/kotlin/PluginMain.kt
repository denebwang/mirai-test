...
//
//        if (this.hasPermission(PluginMain.PERMISSION_EXECUTE_1)) {
//            sendMessage("你有 ${PluginMain.PERMISSION_EXECUTE_1.id} 权限.")
//        } else {
//            sendMessage(
//                """
//                你没有 ${PluginMain.PERMISSION_EXECUTE_1.id} 权限.
...
object MyCompositeCommand : CompositeCommand(
    ...
    suspend fun CommandSender.mute(target: Member, duration: Int) { // 通过 /manage mute <target> <duration> 调用
        sendMessage("mute 被调用了, 参数为: $target, $duration")
